...
# SOURCE_DIR ${Source_Dir}            # Source dir to be used for build
    CONFIGURE_COMMAND  ${Boost_Bootstrap_CMD} --prefix=${CMAKE_CURRENT_LIST_DIR}/boost/ --with-libraries=python # Build tree configuration command
...
# BINARY_DIR   ${Source_Dir}          # Specify build dir location
    ...
    BUILD_COMMAND ${Boost_b2_CMD}       --prefix=${CMAKE_CURRENT_LIST_DIR}/boost/ --with-python # Build tree configuration command
